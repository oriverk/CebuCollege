...
class SubjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subject" do
    assert_difference('Subject.count') do
      post subjects_url, params: { subject: { max_score: @subject.max_score, name: @subject.name } }
    end
  ...
  test "should update subject" do
    patch subject_url(@subject), params: { subject: { max_score: @subject.max_score, name: @subject.name } }
